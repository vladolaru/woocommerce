...
readonly RECONCILE_FIXTURE_STATE_CODE='$fixture = WooCommerce_WooPayments_Native_CI_Provider_Fixture::registered_instance(); if ( ! $fixture ) { fwrite( STDERR, "The WooPayments CI provider fixture is not registered.\n" ); exit( 1 ); } $fixture->reconcile_fixture_state_before_reinstall();'
