...
|----|------|--------|-----------------------|----------------|--------|
| SP-01 | Add PM — regular card | D+A | PM saved; usable | Success notice; listed | PASS (runner-verified 2026-07-14: Layer A dual-store success notice, saved Visa 4242 listing, and checkout reuse; Layer D dual-store persisted customer mapping, provider-bound Visa token, succeeded SetupIntent, zero orders, no charge delta, and clean marker-bounded logs; target Layer-A placeholder divergence remains cosmetic; runs `20260714T134558Z-82856-partial`, `20260714T151826Z-20599-partial`) |
...
| MO-02 | Manual capture — Uncaptured tab | D+A | Capture from list; row leaves tab | Tab lists eligible; capture works | PENDING (Layer D runner-verified PASS 2026-07-16: dual-store exact authorizations-list inclusion → row-route capture → list removal/provider/order/note parity with clean logs; Layer A queued; run `20260716T150009Z-83633-partial`) |
