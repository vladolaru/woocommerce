...
const evidencePath =
	...
	state.evidencePath ||
	path.join( dataDir, `${ gateSlug }-admin-browser-gate.json` );
...
const surfaces = [
	...
	},
	{
		...
		referenceOptional: 'Reference fees reports are account, feature, and version gated in this local account.',
