 ...
 *
 * Measures query count, wall time, and peak-memory delta on three gateway-resolution surfaces.
 * Query count is the enforced narrow smoke signal; time is captured as a best-of-N median for
 * context. Broader design-spec §5.3 performance verification remains a separate stage gate.
 *
 * Run via the wrapper:
